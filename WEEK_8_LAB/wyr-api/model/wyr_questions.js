...
function randomWyrQuestion() {
  const randomIndex = Math.floor(Math.random() * questions.length) // Generate random index
  const randomQuestion = questions[randomIndex]     // Get question at index
  return randomQuestion         // Return the chosen question
}

module.exports = randomWyrQuestion  // Export function for other files
