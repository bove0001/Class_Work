...
console.log(`The wind speed is: ${weather.list[0].wind.speed} m/s`)
console.log(`Discirptions: ${weather.list[0].weather[0].description}, ${weather.list[0].weather[1].description}`)
console.log(`Pressure: ${weather.list[0].main.pressure}`)
